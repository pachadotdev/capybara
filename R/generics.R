...
#' @description
#' \code{\link{coef.felm}} is a generic function which extracts estimates of the structural parameters
#' from objects returned by \code{\link{felm}}.
#' @param
#' object an object of class \code{"felm"}.
#' @param
#' ... other arguments.
#' @return
#' The function \code{\link{coef.felm}} returns a named vector of estimates of the structural
#' parameters.
#' @seealso
#' \code{\link{felm}}
#' @export
...
#' @title
#' Extract \code{felm} fitted values
#' @description
#' \code{\link{fitted.felm}} is a generic function which extracts fitted values from an object
...
#' ... other arguments.
#' @return
#' The function \code{\link{fitted.felm}} returns a vector of fitted values.
#' @seealso
#' \code{\link{felm}}
#' @export
...
#' Print \code{felm}
#' @description
#' \code{\link{print.felm}} is a generic function which displays some minimal information from
#' objects returned by \code{\link{felm}}.
#' @param
#' x an object of class \code{"felm"}.
#' @param
#' digits unsigned integer indicating the number of decimal places. Default is
#' \code{max(3L, getOption("digits") - 3L)}.
#' @param
...
#' @title
#' Print \code{summary.felm}
#' @description
#' \code{\link{print.summary.felm}} is a generic function which displays summary statistics from
#' objects returned by \code{\link{summary.felm}}.
#' @param
#' x an object of class \code{"summary.felm"}.
#' @param
#' digits unsigned integer indicating the number of decimal places. Default is
#' \code{max(3L, getOption("digits") - 3L)}.
#' @param
...
#' @title
#' Summarizing models of class \code{felm}
#' @description
#' Summary statistics for objects of class \code{"felm"}.
#' @param
#' object an object of class \code{"felm"}.
#' @param
...
#' @return
#' Returns an object of class \code{"summary.felm"} which is a list of summary statistics of
#' \code{object}.
#' @references
...
vcov.felm <- function(
    ...
    cluster.vars = NULL,
    ...) {
  vcov.feglm(object, type, cluster, cluster.vars, ...)
}
