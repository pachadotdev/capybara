...
#' srr_stats
#' @srrstats {G1.0} Implements `glance` methods for summarizing model diagnostics for `feglm` and `feols` objects.
...
#' @srrstats {G3.1b} Supports consistent output for both `feglm` and `feols` models.
