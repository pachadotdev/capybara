...
#' @srrstats {G2.1a} Ensures that the input object is of the expected class (`apes`, `feglm`, or `feols`).
...
#' @srrstats {RE4.2} Returns coefficients via a standard method for feglm-type objects and derived classes (i.e., feols, apes, etc).
...
#' @export
#' @noRd
coef.summary.feols <- function(object, ...) {
  object[["coefficients"]]
}
