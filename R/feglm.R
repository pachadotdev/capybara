# srr_stats
# {G1.0} Implements generalized linear models with high-dimensional fixed effects.
...
# {G2.3a} Uses structured checks for parameters like `weights`, `control`, and starting values.
...
# {G3.1a} Provides robust support for a range of family functions like `gaussian`, `poisson`, and `binomial`.
