...
#' @importFrom stats as.formula ave binomial coef complete.cases fitted.values Gamma gaussian
#'  inverse.gaussian model.frame model.matrix model.response na.omit na.pass pnorm poisson predict
#'  printCoefmat qnorm reformulate setNames terms vcov
