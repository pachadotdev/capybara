...
apes <- function(
  ...
  if (control[["keep_mx"]]) {
    ...
    mx <- center_variables_(x, w, k_list, control[["center_tol"]], control[["iter_max"]], control[["iter_interrupt"]], control[["iter_ssr"]], "gaussian")
  }
  ...
  psi <- -delta1 / w
  mpsi <- center_variables_(psi, w, k_list, control[["center_tol"]], control[["iter_max"]], control[["iter_interrupt"]], control[["iter_ssr"]], "gaussian")
  ppsi <- psi - mpsi
  rm(delta1, psi)
