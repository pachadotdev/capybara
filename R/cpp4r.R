...
fenegbin_fit_ <- function(X_r, y_r, w_r, FEs, link, beta_r, eta_r, init_theta, offset_r, control) {
	.Call(`_capybara_fenegbin_fit_`, X_r, y_r, w_r, FEs, link, beta_r, eta_r, init_theta, offset_r, control)
}
