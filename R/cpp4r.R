...
felm_fit_ <- function(X_r, y_r, w_r, fe_codes, fe_levels_r, control, cl_list) {
	.Call(`_capybara_felm_fit_`, X_r, y_r, w_r, fe_codes, fe_levels_r, control, cl_list)
}

feglm_fit_ <- function(beta_r, eta_r, y_r, x_r, wt_r, offset_r, theta, family, control, fe_codes, fe_levels_r, cl_list) {
	.Call(`_capybara_feglm_fit_`, beta_r, eta_r, y_r, x_r, wt_r, offset_r, theta, family, control, fe_codes, fe_levels_r, cl_list)
}
...
fenegbin_fit_ <- function(X_r, y_r, w_r, fe_codes, fe_levels_r, link, beta_r, eta_r, init_theta, offset_r, control) {
	.Call(`_capybara_fenegbin_fit_`, X_r, y_r, w_r, fe_codes, fe_levels_r, link, beta_r, eta_r, init_theta, offset_r, control)
}
