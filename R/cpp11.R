...
center_variables_ <- function(V_r, w_r, klist, tol, max_iter, iter_interrupt, iter_ssr) {
  .Call(`_capybara_center_variables_`, V_r, w_r, klist, tol, max_iter, iter_interrupt, iter_ssr)
}
