...
center_variables_ <- function(V_r, w_r, klist, tol, max_iter, iter_interrupt, iter_ssr, accel_start, project_tol_factor, grand_accel_tol, project_group_tol, irons_tuck_tol, grand_accel_interval, irons_tuck_interval, ssr_check_interval, convergence_factor, tol_multiplier) {
  .Call(`_capybara_center_variables_`, V_r, w_r, klist, tol, max_iter, iter_interrupt, iter_ssr, accel_start, project_tol_factor, grand_accel_tol, project_group_tol, irons_tuck_tol, grand_accel_interval, irons_tuck_interval, ssr_check_interval, convergence_factor, tol_multiplier)
}
