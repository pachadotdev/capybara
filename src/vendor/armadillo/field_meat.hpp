...
//! construct a field from a given field
template <typename oT> inline field<oT> &field<oT>::operator=(const field &x) {
...
//! construct a field from subview_field (eg. construct a field from a delayed
//! subfield operation)
template <typename oT>
...
template <typename oT>
inline field<oT> &field<oT>::set_size(const uword n_rows_in,
...
inline field<oT> &field<oT>::set_size(const uword n_rows_in,
                                      ...
                                      const uword n_slices_in) {
  arma_extra_debug_sigprint(
      arma_str::format("n_rows_in = %u, n_cols_in = %u, n_slices_in = %u") %
...
template <typename oT> inline field<oT> &field<oT>::set_size(const SizeMat &s) {
  arma_extra_debug_sigprint();
...
inline field<oT>::field(field<oT> &&X)
    : n_rows(X.n_rows), n_cols(X.n_cols), n_slices(X.n_slices),
      n_elem(X.n_elem) {
  arma_extra_debug_sigprint(arma_str::format("this = %x   X = %x") % this % &X);
...
template <typename oT> inline field<oT> &field<oT>::operator=(field<oT> &&X) {
  arma_extra_debug_sigprint(arma_str::format("this = %x   X = %x") % this % &X);
...
template <typename oT> arma_inline oT &field<oT>::operator[](const uword i) {
  return (*mem[i]);
}
...
//! linear element accessor (treats the field as a vector); no bounds check
template <typename oT> arma_inline oT &field<oT>::at(const uword i) {
  return (*mem[i]);
}
...
//! linear element accessor (treats the field as a vector); bounds checking not
...
arma_inline oT &field<oT>::operator()(const uword in_row, const uword in_col) {
  arma_debug_check_bounds(
      ((in_row >= n_rows) || (in_col >= n_cols) || (0 >= n_slices)),
      "field::operator(): index out of bounds");
...
//! element accessor; no bounds check
template <typename oT>
arma_inline const oT &field<oT>::at(const uword in_row,
                                    const uword in_col) const {
  return (*mem[in_row + in_col * n_rows]);
}
...
template <typename oT> arma_inline oT &field<oT>::front() {
  arma_debug_check((n_elem == 0), "field::front(): field is empty");

  return (*mem[0]);
}

template <typename oT> arma_inline const oT &field<oT>::front() const {
  arma_debug_check((n_elem == 0), "field::front(): field is empty");

  return (*mem[0]);
}

template <typename oT> arma_inline oT &field<oT>::back() {
  arma_debug_check((n_elem == 0), "field::back(): field is empty");

  return (*mem[n_elem - 1]);
}

template <typename oT> arma_inline const oT &field<oT>::back() const {
  arma_debug_check((n_elem == 0), "field::back(): field is empty");
...
template <typename oT>
inline subview_field<oT> field<oT>::rows(const uword in_row1,
                                         const uword in_row2) {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline subview_field<oT> field<oT>::cols(const uword in_col1,
                                         const uword in_col2) {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline subview_field<oT> field<oT>::slices(const uword in_slice1,
  ...
  return subview_field<oT>(*this, 0, 0, in_slice1, n_rows, n_cols,
                           sub_n_slices);
}
...
field<oT>::subfield(const uword in_row1, const uword in_col1,
...
//! creation of subview_field (subfield with arbitrary dimensions)
template <typename oT>
inline subview_field<oT> field<oT>::subfield(const uword in_row1,
                                             const uword in_col1,
                                             const SizeMat &s) {
  arma_extra_debug_sigprint();
...
field<oT>::subfield(const uword in_row1, const uword in_col1,
  ...
  return subview_field<oT>(*this, in_row1, in_col1, in_slice1, s_n_rows,
                           s_n_cols, sub_n_slices);
}
...
//! creation of subview_field (subfield with arbitrary dimensions)
template <typename oT>
inline subview_field<oT> field<oT>::subfield(const span &row_span,
                                             const span &col_span) {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline subview_field<oT> field<oT>::operator()(const uword in_row1,
                                               const uword in_col1,
                                               const SizeMat &s) {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline subview_field<oT>
field<oT>::operator()(const uword in_row1, const uword in_col1,
                      const uword in_slice1, const SizeCube &s) {
  arma_extra_debug_sigprint();
...
template <typename oT> inline field<oT> &field<oT>::fill(const oT &x) {
  arma_extra_debug_sigprint();
...
template <typename oT> inline void field<oT>::reset() {
  arma_extra_debug_sigprint();
...
//! reset each object
template <typename oT> inline void field<oT>::reset_objects() {
  arma_extra_debug_sigprint();
...
template <typename oT> arma_inline bool field<oT>::is_empty() const {
  return (n_elem == 0);
}
...
template <typename oT>
arma_inline bool field<oT>::in_range(const uword in_row,
                                     const uword in_col) const {
  return ((in_row < n_rows) && (in_col < n_cols));
}

template <typename oT>
arma_inline bool field<oT>::in_range(const span &row_span,
                                     const uword in_col) const {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline bool field<oT>::save(const std::string name,
...
template <typename oT>
inline bool field<oT>::quiet_save(const std::string name,
                                  const file_type type) const {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline bool field<oT>::quiet_save(std::ostream &os,
                                  const file_type type) const {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline bool field<oT>::quiet_load(const std::string name,
...
//! construct a field from a given field
template <typename oT> inline void field<oT>::init(const field<oT> &x) {
  arma_extra_debug_sigprint();
...
template <typename oT> inline void field<oT>::delete_objects() {
...
template <typename oT> inline void field<oT>::create_objects() {
  arma_extra_debug_sigprint(arma_str::format("n_elem = %u") % n_elem);
...
template <typename oT> inline oT &field<oT>::iterator::operator*() {
  return M[i];
}
...
template <typename oT> inline void field<oT>::iterator::operator++(int) {
  operator++();
}
...
template <typename oT>
inline field<oT>::const_iterator::const_iterator(const field<oT> &in_M,
                                                 const bool at_end)
    : M(in_M), i((at_end == false) ? 0 : in_M.n_elem) {
  arma_extra_debug_sigprint();
}
...
template <typename oT>
inline field<oT>::const_iterator::const_iterator(
    const typename field<oT>::iterator &X)
    : M(X.M), i(X.i) {
  arma_extra_debug_sigprint();
}
...
template <typename oT>
inline typename field<oT>::const_iterator &
...
template <typename oT> inline void field<oT>::const_iterator::operator++(int) {
  operator++();
}
...
template <typename oT> inline typename field<oT>::iterator field<oT>::begin() {
  arma_extra_debug_sigprint();
...
template <typename oT> inline typename field<oT>::iterator field<oT>::end() {
  arma_extra_debug_sigprint();
...
template <typename oT> inline void field<oT>::clear() { reset(); }

template <typename oT> inline bool field<oT>::empty() const {
  return (n_elem == 0);
}

template <typename oT> inline uword field<oT>::size() const { return n_elem; }

//
//
//

template <typename oT> inline void field_aux::reset_objects(field<oT> &x) {
  arma_extra_debug_sigprint();
...
template <typename oT>
inline bool field_aux::save(const field<oT> &, const std::string &,
                            const file_type, std::string &err_msg) {
  arma_extra_debug_sigprint();
...
template <typename eT>
inline bool field_aux::load(field<Mat<eT>> &x, std::istream &is,
                            const file_type type, std::string &err_msg) {
  arma_extra_debug_sigprint();
...
template <typename eT>
inline bool field_aux::load(field<Col<eT>> &x, std::istream &is,
                            const file_type type, std::string &err_msg) {
  arma_extra_debug_sigprint();
...
template <typename eT>
inline bool field_aux::load(field<Row<eT>> &x, std::istream &is,
                            const file_type type, std::string &err_msg) {
  arma_extra_debug_sigprint();
...
template <typename eT>
inline bool field_aux::load(field<Cube<eT>> &x, std::istream &is,
                            const file_type type, std::string &err_msg) {
  arma_extra_debug_sigprint();
...
inline bool field_aux::save(const field<std::string> &x,
...
inline bool field_aux::load(field<std::string> &x, std::istream &is,
                            const file_type type, std::string &err_msg) {
  arma_extra_debug_sigprint();
