...
inline void
spglue_rel_lt::apply(SpMat<uword> &out,
...
template <typename T1, typename T2>
inline void spglue_rel_lt::apply_noalias(SpMat<uword> &out,
                                         const SpProxy<T1> &PA,
                                         const SpProxy<T2> &PB) {
  arma_extra_debug_sigprint();
  ...
  while ((x_it != x_end) || (y_it != y_end)) {
    ...
    arma_check((count > max_n_nonzero),
               "internal error: spglue_rel_lt::apply_noalias(): count > "
               "max_n_nonzero");
  }
...
template <typename T1, typename T2>
inline void
spglue_rel_gt::apply(SpMat<uword> &out,
...
template <typename T1, typename T2>
inline void spglue_rel_gt::apply_noalias(SpMat<uword> &out,
                                         const SpProxy<T1> &PA,
                                         const SpProxy<T2> &PB) {
  arma_extra_debug_sigprint();
  ...
  while ((x_it != x_end) || (y_it != y_end)) {
    ...
    arma_check((count > max_n_nonzero),
               "internal error: spglue_rel_gt::apply_noalias(): count > "
               "max_n_nonzero");
  }
...
template <typename T1, typename T2>
inline void
spglue_rel_and::apply(SpMat<uword> &out,
...
template <typename T1, typename T2>
inline void spglue_rel_and::apply_noalias(SpMat<uword> &out,
                                          const SpProxy<T1> &PA,
                                          const SpProxy<T2> &PB) {
  arma_extra_debug_sigprint();
  ...
  const uword max_n_nonzero =
      (std::min)(PA.get_n_nonzero(), PB.get_n_nonzero());
  ...
  while ((x_it != x_end) || (y_it != y_end)) {
    ...
    arma_check((count > max_n_nonzero),
               "internal error: spglue_rel_and::apply_noalias(): count > "
               "max_n_nonzero");
  }
...
template <typename T1, typename T2>
inline void
spglue_rel_or::apply(SpMat<uword> &out,
...
template <typename T1, typename T2>
inline void spglue_rel_or::apply_noalias(SpMat<uword> &out,
                                         const SpProxy<T1> &PA,
                                         const SpProxy<T2> &PB) {
  arma_extra_debug_sigprint();
  ...
  while ((x_it != x_end) || (y_it != y_end)) {
    ...
    arma_check((count > max_n_nonzero),
               "internal error: spglue_rel_or::apply_noalias(): count > "
               "max_n_nonzero");
  }
