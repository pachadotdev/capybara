...
inline bool princomp(
  ...
  const bool status = op_princomp::direct_princomp(coeff_out, score_out,
                                                   latent_out, tsquared_out, X);
...
inline bool princomp(
  ...
  const bool status =
      op_princomp::direct_princomp(coeff_out, score_out, latent_out, X);
