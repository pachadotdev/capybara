...
public:
  ...
  inline static Mat<typename parent::elem_type>
  apply(const subview_each1<parent, mode> &X,
  ...
  inline static Cube<eT> apply(const subview_cube_each1<eT> &X,
                               const Base<eT, T2> &Y);
};
...
public:
  ...
  template <typename T>
  inline static void apply(Mat<std::complex<T>> &out,
  ...
  template <typename T1, typename T2>
  inline static void
  apply(Cube<typename T1::elem_type> &out,
        const mtGlueCube<typename T1::elem_type, T1, T2, glue_powext_cx> &X);

  template <typename T>
  inline static void apply(Cube<std::complex<T>> &out,
                           const Cube<std::complex<T>> &A, const Cube<T> &B);

  template <typename T, typename T2>
  inline static Cube<std::complex<T>>
  apply(const subview_cube_each1<std::complex<T>> &X, const Base<T, T2> &Y);
};
