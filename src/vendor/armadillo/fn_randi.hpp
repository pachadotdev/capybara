...
randi(const uword n_rows, const uword n_cols,
...
arma_warn_unused inline typename arma_scalar_only<eT>::result
...
randi(const uword n_rows, const uword n_cols, const uword n_slices,
      const distr_param &param = distr_param(),
