...
//// Uncomment the above line if you require LAPACK functions to have the
///'noexcept'
/// specification
...
#pragma message(                                                               \
    "INFO: support for ARMA_DONT_PRINT_ERRORS option has been removed")
...
// not defined, ARMA_AUX_LIBS lists the libraries required by Armadillo on this
// system, and ARMA_AUX_INCDIRS lists the include directories required by
// Armadillo on this system. Do not use these unless you know what you are
// doing.
