...
public:
  ...
  inline static void
  apply(SpMat<typename T1::pod_type> &out,
  ...
  // Calculate variance of a sparse vector, where we can directly use the
  // memory.
  template <typename T1>
  inline static typename T1::pod_type var_vec(const T1 &X,
  ...
  inline static eT direct_var(const eT *const X, const uword length,
  ...
  inline static eT
  iterator_var(T1 &it, const T1 &end, const uword n_zero, const uword norm_type,
               const eT junk1,
