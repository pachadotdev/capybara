...
arma_warn_unused inline
    ...
    vecnorm(const T1 &X, const uword k = uword(2),
            ...
            const typename arma_real_or_cx_only<typename T1::elem_type>::result
                *junk2 = nullptr) {
...
template <typename T1>
arma_warn_unused inline const mtOp<typename T1::pod_type, T1, op_vecnorm>
vecnorm(const Base<typename T1::elem_type, T1> &X, const uword k,
        const uword dim,
        const typename arma_real_or_cx_only<typename T1::elem_type>::result
            *junk = nullptr) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtOp<typename T1::pod_type, T1, op_vecnorm_ext>
vecnorm(const Base<typename T1::elem_type, T1> &X, const char *method,
        const uword dim,
        const typename arma_real_or_cx_only<typename T1::elem_type>::result
            *junk = nullptr) {
  arma_extra_debug_sigprint();
  ...
  return mtOp<typename T1::pod_type, T1, op_vecnorm_ext>(X.get_ref(), method_id,
                                                         dim);
}
...
template <typename T1>
arma_warn_unused inline const mtSpOp<typename T1::pod_type, T1, spop_vecnorm>
vecnorm(const SpBase<typename T1::elem_type, T1> &X, const uword k,
        const uword dim,
        const typename arma_real_or_cx_only<typename T1::elem_type>::result
            *junk = nullptr) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtSpOp<typename T1::pod_type, T1,
                                     spop_vecnorm_ext>
vecnorm(const SpBase<typename T1::elem_type, T1> &X, const char *method,
        const uword dim,
        const typename arma_real_or_cx_only<typename T1::elem_type>::result
            *junk = nullptr) {
  arma_extra_debug_sigprint();
  ...
  return mtSpOp<typename T1::pod_type, T1, spop_vecnorm_ext>(X.get_ref(),
                                                             method_id, dim);
}
