...
arma_warn_unused inline typename enable_if2<is_cx<typename T1::elem_type>::no,
...
trace(const SpGlue<SpOp<T1, spop_htrans>, T2, spglue_times> &expr) {
  ...
  // NOTE: deliberately swapped A.n_rows and A.n_cols to take into account the
  // requested transpose operation
