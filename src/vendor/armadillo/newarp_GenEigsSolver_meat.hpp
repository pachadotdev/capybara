...
inline void
GenEigsSolver<eT, SelectionRule, OpType>::fill_rand(eT *dest, const uword N,
...
template <typename eT, int SelectionRule, typename OpType>
inline void GenEigsSolver<eT, SelectionRule, OpType>::factorise_from(
...
inline void GenEigsSolver<eT, SelectionRule, OpType>::retrieve_ritzpair() {
  ...
  SortEigenvalue<std::complex<eT>, SelectionRule> sorting(evals.memptr(),
                                                          evals.n_elem);
...
inline void GenEigsSolver<eT, SelectionRule, OpType>::sort_ritzpair() {
  ...
  SortEigenvalue<std::complex<eT>, SelectionRule> sorting(ritz_val.memptr(),
                                                          nev);
...
template <typename eT, int SelectionRule, typename OpType>
inline GenEigsSolver<eT, SelectionRule, OpType>::GenEigsSolver(
...
template <typename eT, int SelectionRule, typename OpType>
inline uword GenEigsSolver<eT, SelectionRule, OpType>::compute(uword maxit,
                                                               eT tol) {
  arma_extra_debug_sigprint();
