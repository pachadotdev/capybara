...
arma_warn_unused arma_inline const Glue<T1, T2, glue_kron>
kron(const Base<typename T1::elem_type, T1> &A,
...
template <typename T1, typename T2>
arma_warn_unused arma_inline const SpGlue<T1, T2, spglue_kron>
kron(const SpBase<typename T1::elem_type, T1> &A,
