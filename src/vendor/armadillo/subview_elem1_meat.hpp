...
arma_inline subview_elem1<eT, T1>::subview_elem1(const Cube<eT> &in_q,
                                                 const Base<uword, T1> &in_a)
    : fake_m(const_cast<eT *>(in_q.memptr()), in_q.n_elem, 1, false), m(fake_m),
      a(in_a) {
  arma_extra_debug_sigprint();
}
...
inline void subview_elem1<eT, T1>::inplace_op(const eT val) {
  ...
  if (iq < aa_n_elem) {
    ...
    arma_debug_check_bounds((ii >= m_n_elem),
                            "Mat::elem(): index out of bounds");
...
inline void subview_elem1<eT, T1>::inplace_op(const subview_elem1<eT, T2> &x) {
  ...
  if (&(s.m) == &(x.m)) {
    ...
    arma_debug_check(
        (((s_aa.is_vec() == false) && (s_aa.is_empty() == false)) ||
    ...
    arma_debug_check((s_aa_n_elem != x_aa.n_elem),
...
inline void subview_elem1<eT, T1>::inplace_op(const Base<eT, T2> &x) {
  ...
  if ((is_alias == false) && (Proxy<T2>::use_at == false)) {
    ...
    arma_extra_debug_print(
        "subview_elem1::inplace_op(): aliasing or use_at detected");
...
template <typename eT, typename T1> inline void subview_elem1<eT, T1>::zeros() {
  arma_extra_debug_sigprint();

  inplace_op<op_internal_equ>(eT(0));
}

template <typename eT, typename T1> inline void subview_elem1<eT, T1>::ones() {
  arma_extra_debug_sigprint();

  inplace_op<op_internal_equ>(eT(1));
}

template <typename eT, typename T1> inline void subview_elem1<eT, T1>::randu() {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1> inline void subview_elem1<eT, T1>::randn() {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
template <typename op_type>
inline void subview_elem1<eT, T1>::mat_inplace_op(Mat<eT> &out,
                                                  const subview_elem1 &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void subview_elem1<eT, T1>::plus_inplace(Mat<eT> &out,
                                                const subview_elem1 &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void subview_elem1<eT, T1>::minus_inplace(Mat<eT> &out,
                                                 const subview_elem1 &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void subview_elem1<eT, T1>::schur_inplace(Mat<eT> &out,
                                                 const subview_elem1 &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void subview_elem1<eT, T1>::div_inplace(Mat<eT> &out,
                                               const subview_elem1 &in) {
  arma_extra_debug_sigprint();
