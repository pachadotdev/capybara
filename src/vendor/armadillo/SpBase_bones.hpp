...
template <typename elem_type, typename derived> struct SpBase_eval_expr {
  arma_warn_unused inline SpMat<elem_type>
...
struct SpBase
  ...
  arma_warn_unused inline const SpOp<derived, spop_htrans>
  t() const; //!< Hermitian transpose
  arma_warn_unused inline const SpOp<derived, spop_htrans>
  ht() const; //!< Hermitian transpose
  arma_warn_unused inline const SpOp<derived, spop_strans>
  st() const; //!< simple transpose
  ...
  raw_print_dense(const std::string extra_text = "") const;
  arma_cold inline void
  raw_print_dense(std::ostream &user_stream,
                  const std::string extra_text = "") const;
  ...
  arma_warn_unused inline const SpOp<derived, spop_vectorise_col>
  as_col() const;
  arma_warn_unused inline const SpOp<derived, spop_vectorise_row>
  as_row() const;
};
