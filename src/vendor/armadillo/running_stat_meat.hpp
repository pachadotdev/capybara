...
template <typename eT> inline void arma_counter<eT>::operator++(int) {
  operator++();
}
...
template <typename eT> inline eT arma_counter<eT>::value() const {
...
inline running_stat<eT>::running_stat()
    : r_mean(eT(0)), r_var(typename running_stat<eT>::T(0)), min_val(eT(0)),
      max_val(eT(0)), min_val_norm(typename running_stat<eT>::T(0)),
...
//! variance
template <typename eT>
inline typename running_stat<eT>::T
...
template <typename eT>
inline void
running_stat_aux::update_stats(running_stat<eT> &x,
...
inline void
running_stat_aux::update_stats(running_stat<eT> &x,
                               const typename eT::value_type sample,
...
//! alter statistics to reflect new sample (version for complex numbers, complex
//! sample)
template <typename eT>
inline void
running_stat_aux::update_stats(running_stat<eT> &x, const eT &sample,
