...
#define arma_applier_mat(operator_rel, operator_str)                           \
  {                                                                            \
    ...
    if (bad_alias == false) {                                                  \
      ...
      if (use_at == false) {                                                   \
        ...
        if (n_rows == 1) {                                                     \
          for (uword count = 0; count < n_cols; ++count) {                     \
            out_mem[count] = (P1.at(0, count) operator_rel P2.at(0, count))    \
                                 ? uword(1)                                    \
                                 : uword(0);                                   \
          }                                                                    \
        } else {                                                               \
          for (uword col = 0; col < n_cols; ++col)                             \
            for (uword row = 0; row < n_rows; ++row) {                         \
              *out_mem = (P1.at(row, col) operator_rel P2.at(row, col))        \
                             ? uword(1)                                        \
                             : uword(0);                                       \
              out_mem++;                                                       \
            }                                                                  \
      ...
      const unwrap_check<typename Proxy<T1>::stored_type> tmp1(                \
          P1.Q, P1.is_alias(out));                                             \
      const unwrap_check<typename Proxy<T2>::stored_type> tmp2(                \
          P2.Q, P2.is_alias(out));                                             \
                                                                               \
      ...
      if (use_at == false) {                                                   \
        ...
        for (uword slice = 0; slice < n_slices; ++slice)                       \
          for (uword col = 0; col < n_cols; ++col)                             \
            for (uword row = 0; row < n_rows; ++row) {                         \
              *out_mem =                                                       \
                  (P1.at(row, col, slice) operator_rel P2.at(row, col, slice)) \
                      ? uword(1)                                               \
                      : uword(0);                                              \
              out_mem++;                                                       \
            }                                                                  \
...
template <typename T1, typename T2>
inline void
glue_rel_lteq::apply(Mat<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_gteq::apply(Mat<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_noteq::apply(Mat<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_lt::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_gt::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_lteq::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_gteq::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_eq::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_noteq::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_and::apply(Cube<uword> &out,
...
template <typename T1, typename T2>
inline void
glue_rel_or::apply(Cube<uword> &out,
