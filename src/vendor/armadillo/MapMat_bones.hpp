...
// this class is for internal use only; subject to change and/or removal without
// notice
...
public:
  ...
  arma_warn_unused arma_inline MapMat_val<eT> at(const uword in_row,
                                                 const uword in_col);
  ...
  inline void sprandu(const uword in_n_rows, const uword in_n_cols,
...
private:
  arma_inline SpSubview_MapMat_val(SpSubview<eT> &in_sv_parent,
                                   MapMat<eT> &in_m_parent, const uword in_row,
                                   const uword in_col);
