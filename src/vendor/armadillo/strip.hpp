...
template <typename T1> struct strip_inv<Op<T1, op_inv_gen_default>> {
  typedef T1 stored_type;
...
template <typename T1> struct strip_inv<Op<T1, op_inv_spd_default>> {
  typedef T1 stored_type;
...
template <typename T1> struct sp_strip_trans {
  typedef T1 stored_type;
...
template <typename T1> struct sp_strip_trans<SpOp<T1, spop_htrans>> {
  typedef T1 stored_type;
...
template <typename T1> struct sp_strip_trans<SpOp<T1, spop_strans>> {
  typedef T1 stored_type;
