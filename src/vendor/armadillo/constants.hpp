...
public:
  ...
  static typename arma_real_only<eT>::result
  ...
  template <typename eT>
  static typename arma_cx_only<eT>::result
  ...
  template <typename eT>
  static typename arma_integral_only<eT>::result
...
//! various constants.
//! Physical constants taken from NIST 2018 CODATA values, and some from
//! WolframAlpha (values provided as of 2009-06-23)
//! http://physics.nist.gov/cuu/Constants http://www.wolframalpha.com See also
//! http://en.wikipedia.org/wiki/Physical_constant

template <typename eT> class Datum {
public:
  static const eT pi;  //!< ratio of any circle's circumference to its diameter
  static const eT tau; //!< ratio of any circle's circumference to its radius
                       //!< (replacement of 2*pi)
  ...
  static const eT eps; //!< the difference between 1 and the least value greater
