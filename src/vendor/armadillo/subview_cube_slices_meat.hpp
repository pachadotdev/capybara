...
template <typename eT, typename T1>
arma_inline
subview_cube_slices<eT, T1>::subview_cube_slices(const Cube<eT> &in_m,
...
inline void subview_cube_slices<eT, T1>::inplace_rand(const uword rand_mode) {
  ...
  for (uword si_count = 0; si_count < si_n_elem; ++si_count) {
    ...
    arma_debug_check_bounds((i >= m_n_slices),
...
subview_cube_slices<eT, T1>::inplace_op(const BaseCube<eT, expr> &x) {
  ...
  arma_debug_assert_same_size(m_local.n_rows, m_local.n_cols, si_n_elem,
                              X.n_rows, X.n_cols, X.n_slices, "Cube::slices()");
...
template <typename eT, typename T1>
inline void
subview_cube_slices<eT, T1>::extract(Cube<eT> &out,
...
template <typename eT, typename T1>
inline void
subview_cube_slices<eT, T1>::plus_inplace(Cube<eT> &out,
...
template <typename eT, typename T1>
inline void
subview_cube_slices<eT, T1>::minus_inplace(Cube<eT> &out,
                                           const subview_cube_slices &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void
subview_cube_slices<eT, T1>::schur_inplace(Cube<eT> &out,
                                           const subview_cube_slices &in) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1>
inline void
subview_cube_slices<eT, T1>::div_inplace(Cube<eT> &out,
                                         const subview_cube_slices &in) {
  arma_extra_debug_sigprint();
