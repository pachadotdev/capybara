...
arma_warn_unused inline Mat<eT>
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline Mat<eT> join_horiz(const Base<eT, T1> &A,
                                           const Base<eT, T2> &B,
                                           const Base<eT, T3> &C) {
  arma_extra_debug_sigprint();
...
join_slices(const Base<typename T1::elem_type, T1> &A,
...
join_slices(const Base<typename T1::elem_type, T1> &A,
  ...
  const Cube<eT> M(const_cast<eT *>(U.M.memptr()), U.M.n_rows, U.M.n_cols, 1,
                   false);
...
join_cols(const SpBase<typename T1::elem_type, T1> &A,
...
template <typename eT, typename T1, typename T2, typename T3, typename T4>
arma_warn_unused inline SpMat<eT>
join_cols(const SpBase<eT, T1> &A, const SpBase<eT, T2> &B,
          const SpBase<eT, T3> &C, const SpBase<eT, T4> &D) {
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_cols>
join_vert(const SpBase<typename T1::elem_type, T1> &A,
          const SpBase<typename T1::elem_type, T2> &B) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3, typename T4>
arma_warn_unused inline SpMat<eT>
join_vert(const SpBase<eT, T1> &A, const SpBase<eT, T2> &B,
          const SpBase<eT, T3> &C, const SpBase<eT, T4> &D) {
  arma_extra_debug_sigprint();
...
join_rows(const SpBase<typename T1::elem_type, T1> &A,
          const SpBase<typename T1::elem_type, T2> &B) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3, typename T4>
arma_warn_unused inline SpMat<eT>
join_rows(const SpBase<eT, T1> &A, const SpBase<eT, T2> &B,
          const SpBase<eT, T3> &C, const SpBase<eT, T4> &D) {
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_rows>
join_horiz(const SpBase<typename T1::elem_type, T1> &A,
           const SpBase<typename T1::elem_type, T2> &B) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3, typename T4>
arma_warn_unused inline SpMat<eT>
join_horiz(const SpBase<eT, T1> &A, const SpBase<eT, T2> &B,
           const SpBase<eT, T3> &C, const SpBase<eT, T4> &D) {
  arma_extra_debug_sigprint();
