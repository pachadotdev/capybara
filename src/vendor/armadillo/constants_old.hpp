...
public:
  arma_frown("use datum::pi instead") static eT pi() {
    return eT(Datum<eT>::pi);
  }
  ...
  arma_frown("use datum::eps instead") static eT eps() {
    return eT(Datum<eT>::eps);
  }
  ...
  arma_frown("use datum::nan instead") static eT nan() {
    return eT(Datum<eT>::nan);
  }
  arma_frown("use datum::inf instead") static eT inf() {
    return eT(Datum<eT>::inf);
  }
};
