...
template <typename eT>
inline SpCol<eT>::SpCol(const SizeMat &s)
...
// inline
// void
// SpCol<eT>::insert_rows(const uword row_num, const uword N, const bool
// set_to_zero)
//   {
//   arma_extra_debug_sigprint();
//
//   arma_debug_check(set_to_zero == false, "SpCol::insert_rows(): cannot set
//   nonzero values");
//
//   arma_debug_check_bounds((row_num > SpMat<eT>::n_rows),
//   "SpCol::insert_rows(): out of bounds");
//
...
template <typename eT>
inline typename SpCol<eT>::row_iterator
...
template <typename eT>
inline typename SpCol<eT>::const_row_iterator
