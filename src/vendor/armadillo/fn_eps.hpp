...
arma_warn_unused arma_inline typename arma_integral_only<eT>::result
eps(const eT &x) {
  arma_ignore(x);
...
template <typename eT>
arma_warn_unused arma_inline typename arma_real_only<eT>::result
eps(const eT &x) {
  return eop_aux::direct_eps(x);
}

template <typename T>
arma_warn_unused arma_inline typename arma_real_only<T>::result
