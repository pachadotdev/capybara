...
template <typename T1>
arma_warn_unused arma_inline const OpCube<T1, op_max>
max(const BaseCube<typename T1::elem_type, T1> &X, const uword dim = 0) {
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused arma_inline const GlueCube<T1, T2, glue_max>
