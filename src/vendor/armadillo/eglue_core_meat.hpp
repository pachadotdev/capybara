...
#define arma_applier_1_mp(operatorA, operatorB)                                \
  arma_applier_1u(operatorA, operatorB)
#define arma_applier_2_mp(operatorA, operatorB)                                \
  arma_applier_2(operatorA, operatorB)
#define arma_applier_3_mp(operatorA, operatorB)                                \
  arma_applier_3(operatorA, operatorB)
...
inline void eglue_core<eglue_type>::apply(outT &out,
  ...
  if (use_at == false) {
    ...
    if (use_mp && mp_gate<eT, (Proxy<T1>::use_mp && Proxy<T2>::use_mp)>::eval(
                      x.get_n_elem())) {
      if (is_same_type<eglue_type, eglue_plus>::yes) {
        arma_applier_2_mp(=, +);
      } else if (is_same_type<eglue_type, eglue_minus>::yes) {
...
template <typename T1, typename T2>
inline void
eglue_core<eglue_type>::apply(Cube<typename T1::elem_type> &out,
  ...
  if (use_at == false) {
    ...
    if (use_mp &&
        mp_gate<eT, (ProxyCube<T1>::use_mp && ProxyCube<T2>::use_mp)>::eval(
            n_elem)) {
