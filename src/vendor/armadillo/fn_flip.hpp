...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_flipud>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_fliplr>
