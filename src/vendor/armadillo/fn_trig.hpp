...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_cos>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_acos>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_cosh>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_acosh>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sin>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_asin>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sinh>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_asinh>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_tan>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_atan>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_tanh>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_atanh>
...
template <typename T>
arma_warn_unused arma_inline typename arma_scalar_only<T>::result
sinc(const T x) {
  return arma_sinc(x);
}
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sinc>
