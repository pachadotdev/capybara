...
inline subview_cube_each_common<eT>::subview_cube_each_common(
    const Cube<eT> &in_p)
    : P(in_p) {
...
subview_cube_each_common<eT>::incompat_size_string(const Mat<eT2> &A) const {
  ...
  tmp << "each_slice(): incompatible size; expected " << P.n_rows << 'x'
      << P.n_cols << ", got " << A.n_rows << 'x' << A.n_cols;
...
template <typename eT, typename TB>
inline subview_cube_each2<eT, TB>::subview_cube_each2(
    const Cube<eT> &in_p, const Base<uword, TB> &in_indices)
    : subview_cube_each_common<eT>::subview_cube_each_common(in_p),
...
subview_cube_each2<eT, TB>::check_indices(const Mat<uword> &indices) const {
  arma_debug_check(
      ((indices.is_vec() == false) && (indices.is_empty() == false)),
...
inline void subview_cube_each2<eT, TB>::operator=(const Base<eT, T1> &in) {
  ...
  for (uword i = 0; i < N; ++i) {
    ...
    arma_debug_check_bounds((slice >= p_n_slices),
                            "each_slice(): index out of bounds");
...
inline Cube<eT>
subview_cube_each1_aux::operator_plus(const subview_cube_each1<eT> &X,
                                      const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
  ...
  for (uword i = 0; i < p_n_slices; ++i) {
    ...
    const Mat<eT> p_slice(const_cast<eT *>(p.slice_memptr(i)), p_n_rows,
                          p_n_cols, false, true);
...
template <typename eT, typename T2>
inline Cube<eT>
subview_cube_each1_aux::operator_minus(const subview_cube_each1<eT> &X,
                                       const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
inline Cube<eT>
subview_cube_each1_aux::operator_minus(const Base<eT, T1> &X,
...
template <typename eT, typename T2>
inline Cube<eT>
subview_cube_each1_aux::operator_schur(const subview_cube_each1<eT> &X,
                                       const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T2>
inline Cube<eT>
subview_cube_each1_aux::operator_div(const subview_cube_each1<eT> &X,
                                     const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
template <typename T1, typename eT>
inline Cube<eT>
subview_cube_each1_aux::operator_div(const Base<eT, T1> &X,
                                     const subview_cube_each1<eT> &Y) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T2>
inline Cube<eT>
subview_cube_each1_aux::operator_times(const subview_cube_each1<eT> &X,
                                       const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
  ...
  for (uword i = 0; i < C.n_slices; ++i) {
    ...
    const Mat<eT> C_slice(const_cast<eT *>(C.slice_memptr(i)), C.n_rows,
                          C.n_cols, false, true);
...
template <typename T1, typename eT>
inline Cube<eT>
subview_cube_each1_aux::operator_times(const Base<eT, T1> &X,
                                       const subview_cube_each1<eT> &Y) {
  arma_extra_debug_sigprint();
...
inline Cube<eT>
subview_cube_each2_aux::operator_plus(const subview_cube_each2<eT, TB> &X,
                                      const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename TB, typename T2>
inline Cube<eT>
subview_cube_each2_aux::operator_minus(const subview_cube_each2<eT, TB> &X,
                                       const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
inline Cube<eT>
subview_cube_each2_aux::operator_minus(const Base<eT, T1> &X,
  ...
  for (uword i = 0; i < N; ++i) {
    ...
    const Mat<eT> p_slice(const_cast<eT *>(p.slice_memptr(slice)), p_n_rows,
                          p_n_cols, false, true);
...
template <typename eT, typename TB, typename T2>
inline Cube<eT>
subview_cube_each2_aux::operator_schur(const subview_cube_each2<eT, TB> &X,
                                       const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename TB, typename T2>
inline Cube<eT>
subview_cube_each2_aux::operator_div(const subview_cube_each2<eT, TB> &X,
                                     const Base<eT, T2> &Y) {
  arma_extra_debug_sigprint();
...
template <typename T1, typename eT, typename TB>
inline Cube<eT>
subview_cube_each2_aux::operator_div(const Base<eT, T1> &X,
                                     const subview_cube_each2<eT, TB> &Y) {
  arma_extra_debug_sigprint();
