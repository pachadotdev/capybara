...
template <typename T1>
inline void
op_real::apply(Cube<typename T1::pod_type> &out,
...
template <typename T1>
inline void
op_imag::apply(Cube<typename T1::pod_type> &out,
...
template <typename T1>
inline void
op_abs::apply(Cube<typename T1::pod_type> &out,
...
template <typename T1>
inline void
op_arg::apply(Cube<typename T1::pod_type> &out,
