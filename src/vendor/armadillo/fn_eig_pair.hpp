...
arma_warn_unused inline
  ...
  const bool status = auxlib::eig_pair(eigvals, eigvecs, false,
...
eig_pair(Col<std::complex<typename T1::pod_type>> &eigvals,
  ...
  const bool status = auxlib::eig_pair(eigvals, eigvecs, true, A_expr.get_ref(),
                                       B_expr.get_ref());
...
eig_pair(Col<std::complex<typename T1::pod_type>> &eigvals,
  ...
  const bool status = auxlib::eig_pair_twosided(
      eigvals, leigvecs, reigvecs, A_expr.get_ref(), B_expr.get_ref());
