...
public:
  ...
  inline Col(eT *aux_mem, const uword aux_length,
  ...
  arma_frown("use braced initialiser list instead") inline mat_injector<Col>
...
protected:
  inline Col(const arma_fixed_indicator &, const uword in_n_elem,
             const eT *in_mem);
