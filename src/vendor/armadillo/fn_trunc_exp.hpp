...
arma_warn_unused inline static typename arma_real_only<eT>::result
...
template <typename eT>
arma_warn_unused inline static typename arma_integral_only<eT>::result
trunc_exp(const eT x) {
...
arma_warn_unused arma_inline
    typename enable_if2<is_arma_type<T1>::value,
                        const eOp<T1, eop_trunc_exp>>::result
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_trunc_exp>
