...
public:
  ...
  inline void set_size(const uword new_n_chars) {
    ...
    n_chars =
        (new_n_chars <= n_chars_prealloc) ? n_chars_prealloc : new_n_chars;
...
inline std::string str(const basic_format<basic_format<format, T2>, T3> &X) {
  ...
  while (status == false) {
    int required_size = (std::snprintf)(buf.mem, size_t(buf.n_chars),
                                        X.A.A.fmt.c_str(), X.A.B, X.B);
...
str(const basic_format<basic_format<basic_format<format, T2>, T3>, T4> &X) {
  ...
  while (status == false) {
    int required_size = (std::snprintf)(
        buf.mem, size_t(buf.n_chars), X.A.A.A.fmt.c_str(), X.A.A.B, X.A.B, X.B);
...
str(const basic_format<
    basic_format<basic_format<basic_format<format, T2>, T3>, T4>, T5> &X) {
  char_buffer buf;
  std::string out;
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.A.A.fmt.c_str(),
                        X.A.A.A.B, X.A.A.B, X.A.B, X.B);
...
inline std::string
str(const basic_format<
    basic_format<basic_format<basic_format<basic_format<format, T2>, T3>, T4>,
                 T5>,
    T6> &X) {
  char_buffer buf;
  std::string out;
...
str(const basic_format<
    basic_format<
        basic_format<
            basic_format<basic_format<basic_format<format, T2>, T3>, T4>, T5>,
        T6>,
    T7> &X) {
  char_buffer buf;
  std::string out;
  ...
  while (status == false) {
    int required_size = (std::snprintf)(
        buf.mem, size_t(buf.n_chars), X.A.A.A.A.A.A.fmt.c_str(), X.A.A.A.A.A.B,
        X.A.A.A.A.B, X.A.A.A.B, X.A.A.B, X.A.B, X.B);
...
str_wrapper(const T1 &x,
            const typename string_only<T1>::result *junk = nullptr) {
  arma_ignore(junk);
...
str_wrapper(const T1 &x,
            const typename basic_format_only<T1>::result *junk = nullptr) {
  arma_ignore(junk);
