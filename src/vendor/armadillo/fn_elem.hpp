...
template <typename T1>
arma_warn_unused arma_inline const T1 &
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_real>
...
imag(const Base<typename T1::pod_type, T1> &X) {
  ...
  return Gen<Mat<typename T1::pod_type>, gen_zeros>(A.get_n_rows(),
                                                    A.get_n_cols());
}
...
imag(const BaseCube<typename T1::pod_type, T1> &X) {
  ...
  return GenCube<typename T1::pod_type, gen_zeros>(
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_imag>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log2>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log10>
...
template <typename T1>
arma_warn_unused arma_inline
    typename enable_if2<is_cx<typename T1::elem_type>::no,
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp2>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp10>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_abs>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_abs>
abs(const SpBase<typename T1::elem_type, T1> &X,
    const typename arma_not_cx<typename T1::elem_type>::result *junk =
        nullptr) {
  arma_extra_debug_sigprint();
  arma_ignore(junk);
...
arma_warn_unused arma_inline const
    mtSpOp<typename T1::pod_type, T1, spop_cx_abs>
    abs(const SpBase<std::complex<typename T1::pod_type>, T1> &X,
        const typename arma_cx_only<typename T1::elem_type>::result *junk =
            nullptr) {
  arma_extra_debug_sigprint();
  arma_ignore(junk);
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_arg>
arg(const BaseCube<typename T1::elem_type, T1> &X,
    const typename arma_not_cx<typename T1::elem_type>::result *junk =
        nullptr) {
  arma_extra_debug_sigprint();
...
arg(const BaseCube<std::complex<typename T1::pod_type>, T1> &X,
    const typename arma_cx_only<typename T1::elem_type>::result *junk =
        nullptr) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_arg>
arg(const SpBase<typename T1::elem_type, T1> &X,
    const typename arma_not_cx<typename T1::elem_type>::result *junk =
        nullptr) {
  arma_extra_debug_sigprint();
  arma_ignore(junk);
...
template <typename T1>
arma_warn_unused arma_inline const
    mtSpOp<typename T1::pod_type, T1, spop_cx_arg>
    arg(const SpBase<std::complex<typename T1::pod_type>, T1> &X,
        const typename arma_cx_only<typename T1::elem_type>::result *junk =
            nullptr) {
  arma_extra_debug_sigprint();
  arma_ignore(junk);
...
arma_warn_unused arma_inline
    typename enable_if2<is_arma_type<T1>::value,
                        const eOp<T1, eop_square>>::result
    square(const T1 &A) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_square>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_square>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sqrt>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_sqrt>
...
template <typename T1>
arma_warn_unused arma_inline const eOp<T1, eop_conj>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_conj>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_conj>
...
template <typename T1>
arma_warn_unused arma_inline const eOp<T1, eop_pow>
pow(const Base<typename T1::elem_type, T1> &A,
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_pow>
pow(const BaseCube<typename T1::elem_type, T1> &A,
    const typename T1::elem_type exponent) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_floor>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_floor>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_ceil>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_ceil>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_round>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_round>
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_trunc>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_trunc>
...
arma_warn_unused arma_inline typename arma_scalar_only<eT>::result
sign(const eT x) {
  arma_extra_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sign>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_sign>
...
template <typename T1> void exp_approx(const T1 &) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1> void log_approx(const T1 &) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1> void approx_exp(const T1 &) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1> void approx_log(const T1 &) {
  arma_stop_logic_error("unimplemented");
}
