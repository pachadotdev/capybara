...
inline mat_injector<T1>::mat_injector(
    T1 &in_parent, const typename mat_injector<T1>::elem_type val)
    : parent(in_parent) {
...
template <typename T1>
inline const mat_injector<T1> &
operator<<(const mat_injector<T1> &ref,
...
template <typename T1>
inline field_injector<T1>::field_injector(T1 &in_parent,
                                          const injector_end_of_row<> &)
    : parent(in_parent) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const field_injector<T1> &
operator<<(const field_injector<T1> &ref,
