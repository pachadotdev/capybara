...
arma_warn_unused arma_inline const Op<T1, op_trimat>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_trimat>
...
template <typename T1>
arma_warn_unused arma_inline const Op<T1, op_trimatl_ext>
...
template <typename T1>
arma_warn_unused arma_inline const Op<T1, op_trimatu_ext>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_trimatu_ext>
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_trimatl_ext>
