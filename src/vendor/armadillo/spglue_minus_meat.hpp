...
template <typename T1, typename T2>
inline void
spglue_minus_mixed::apply(SpMat<typename eT_promoter<T1, T2>::eT> &out,
                          const mtSpGlue<typename eT_promoter<T1, T2>::eT, T1,
                                         T2, spglue_minus_mixed> &expr) {
  arma_extra_debug_sigprint();
...
inline void spglue_minus_mixed::sparse_minus_dense(
  ...
  arma_debug_assert_same_size(pa.get_n_rows(), pa.get_n_cols(), out.n_rows,
                              out.n_cols, "subtraction");
...
inline void spglue_minus_mixed::dense_minus_sparse(
  ...
  arma_debug_assert_same_size(out.n_rows, out.n_cols, pb.get_n_rows(),
                              pb.get_n_cols(), "subtraction");
