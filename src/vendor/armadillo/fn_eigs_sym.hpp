...
arma_warn_unused inline
  ...
  const bool status =
      sp_auxlib::eigs_sym(eigval, eigvec, X, n_eigvals, form_val, opts);
...
arma_warn_unused inline
  ...
  const bool status =
      sp_auxlib::eigs_sym(eigval, eigvec, X, n_eigvals, T(sigma), opts);
...
//! this form is deprecated; use eigs_sym(eigval, X, n_eigvals, form, opts)
//! instead
template <typename T1>
arma_deprecated inline
...
//! this form is deprecated; use eigs_sym(eigval, eigvec, X, n_eigvals, form,
//! opts) instead
template <typename T1>
arma_deprecated inline
    typename enable_if2<is_real<typename T1::elem_type>::value, bool>::result
