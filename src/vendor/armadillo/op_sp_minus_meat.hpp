...
inline void
op_sp_minus_pre::apply_inside_schur(SpMat<eT> &out, const T2 &x,
...
template <typename eT, typename T2, typename T3>
inline void
op_sp_minus_pre::apply_inside_div(SpMat<eT> &out, const T2 &x,
                                  const SpToDOp<T3, op_sp_minus_pre> &y) {
  arma_extra_debug_sigprint();
...
template <typename eT, typename T2, typename T3>
inline void
op_sp_minus_post::apply_inside_schur(SpMat<eT> &out, const T2 &x,
...
template <typename eT, typename T2, typename T3>
inline void
op_sp_minus_post::apply_inside_div(SpMat<eT> &out, const T2 &x,
                                   const SpToDOp<T3, op_sp_minus_post> &y) {
  arma_extra_debug_sigprint();
