...
inline void
op_stddev::apply(Mat<typename T1::pod_type> &out,
  ...
  arma_debug_check((norm_type > 1),
                   "stddev(): parameter 'norm_type' must be 0 or 1");
...
inline void
op_stddev::apply_noalias(Mat<typename get_pod_type<in_eT>::result> &out,
