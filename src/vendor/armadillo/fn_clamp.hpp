...
clamp(const T1 &X, const typename T1::elem_type min_val,
  ...
  return mtOp<typename T1::elem_type, T1, op_clamp>(mtOp_dual_aux_indicator(),
                                                    X, min_val, max_val);
}
...
clamp(const T1 &X, const typename T1::elem_type min_val,
  ...
  return mtOp<typename T1::elem_type, T1, op_clamp_cx>(
      mtOp_dual_aux_indicator(), X, min_val, max_val);
}

template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::elem_type, T1, op_clamp>
clamp(const BaseCube<typename T1::elem_type, T1> &X,
  ...
  return mtOpCube<typename T1::elem_type, T1, op_clamp>(
      mtOpCube_dual_aux_indicator(), X.get_ref(), min_val, max_val);
}

template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::elem_type, T1, op_clamp_cx>
clamp(const BaseCube<typename T1::elem_type, T1> &X,
      const typename T1::elem_type min_val,
      const typename T1::elem_type max_val,
  ...
  return mtOpCube<typename T1::elem_type, T1, op_clamp_cx>(
      mtOpCube_dual_aux_indicator(), X.get_ref(), min_val, max_val);
}

template <typename T1>
arma_warn_unused inline SpMat<typename T1::elem_type>
clamp(const SpBase<typename T1::elem_type, T1> &X,
      const typename T1::elem_type min_val,
      const typename T1::elem_type max_val) {
  arma_extra_debug_sigprint();
