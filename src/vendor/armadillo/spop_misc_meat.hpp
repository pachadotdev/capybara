...
template <typename T1>
inline void
spop_cx_scalar_times::apply(SpMat<std::complex<typename T1::pod_type>> &out,
                            const mtSpOp<std::complex<typename T1::pod_type>,
                                         T1, spop_cx_scalar_times> &in) {
  arma_extra_debug_sigprint();
...
struct functor_square {
  template <typename eT> arma_inline eT operator()(const eT val) const {
    return val * val;
  }
};
} // namespace priv
...
template <typename T1>
inline void
spop_cx_abs::apply(SpMat<typename T1::pod_type> &out,
...
template <typename T1>
inline void
spop_cx_arg::apply(SpMat<typename T1::pod_type> &out,
...
template <typename T1>
inline void
spop_real::apply(SpMat<typename T1::pod_type> &out,
...
template <typename T1>
inline void
spop_imag::apply(SpMat<typename T1::pod_type> &out,
