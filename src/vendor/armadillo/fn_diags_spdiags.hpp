...
inline Mat<typename T1::elem_type>
diags(const Base<typename T1::elem_type, T1> &V_expr,
      const Base<sword, T2> &D_expr, const uword n_rows, const uword n_cols) {
...
template <typename T1, typename T2>
inline SpMat<typename T1::elem_type>
spdiags(const Base<typename T1::elem_type, T1> &V_expr,
        const Base<sword, T2> &D_expr, const uword n_rows, const uword n_cols) {
  arma_extra_debug_sigprint();
