...
template <typename T1, typename T2>
inline void
spglue_schur_misc::dense_schur_sparse(SpMat<typename T1::elem_type> &out,
  ...
  while (it != it_end) {
    ...
    arma_check((count > max_n_nonzero),
               "internal error: spglue_schur_misc::dense_schur_sparse(): count "
               "> max_n_nonzero");
  }
...
template <typename T1, typename T2>
inline void
spglue_schur_mixed::apply(SpMat<typename eT_promoter<T1, T2>::eT> &out,
                          const mtSpGlue<typename eT_promoter<T1, T2>::eT, T1,
                                         T2, spglue_schur_mixed> &expr) {
  arma_extra_debug_sigprint();
