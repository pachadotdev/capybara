...
// #pragma message ("WARNING: disabled use of 64 bit integers, as std::size_t is
...
// NOTE: Apple accelerate framework has broken implementations of functions that
// return a float value, NOTE: such as sdot(), slange(), clange(), slansy(),
// clanhe(), slangb()
...
#if defined(__GNUG__) &&                                                       \
    (!defined(__clang__) && !defined(ARMA_DETECTED_FAKE_GCC))

// #pragma message ("using GCC extensions")

#undef ARMA_GCC_VERSION
#define ARMA_GCC_VERSION                                                       \
...
//   #pragma message ("WARNING: support for gcc versions older than 6.1 is
//   deprecated")
// #endif
...
// TODO: __INTEL_CLANG_COMPILER indicates the clang based intel compiler,
// distinct from the classic intel compiler
...
#pragma message(                                                               \
    "WARNING: #define ARMA_ALLOW_FAKE_CLANG before #include <armadillo>")
#endif
#endif
...
#pragma warning(disable : 4519) // default template args are only allowed on a
                                // class template (C++11)
...
// NOTE: also possible to disable 4146 (unary minus operator applied to unsigned
...
#pragma message(                                                               \
    "WARNING: use of OpenMP disabled due to compiler bug in gcc <= 5.3")
#endif
#endif
#endif
...
// optionally allow disabling of compile-time deprecation messages (not
// recommended) NOTE: option 'ARMA_IGNORE_DEPRECATED_MARKER' will be removed
// NOTE: disabling deprecation messages is counter-productive

#if defined(ARMA_IGNORE_DEPRECATED_MARKER) &&                                  \
    (!defined(ARMA_DONT_IGNORE_DEPRECATED_MARKER)) &&                          \
    (!defined(ARMA_EXTRA_DEBUG))
#undef arma_deprecated
#define arma_deprecated
