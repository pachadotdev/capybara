...
inline void glue_histc::apply_noalias(Mat<uword> &C, const Mat<eT> &A,
                                      const Mat<eT> &B, const uword dim) {
  ...
  arma_debug_check(
      ...
      "hist(): given 'edges' vector does not contain monotonically increasing "
      "values");
