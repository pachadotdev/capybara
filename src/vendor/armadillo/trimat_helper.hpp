...
template <typename eT> inline bool is_triu(const Mat<eT> &A) {
...
template <typename eT> inline bool is_tril(const Mat<eT> &A) {
  arma_extra_debug_sigprint();
...
template <typename eT> inline bool has_nonfinite_tril(const Mat<eT> &A) {
  arma_extra_debug_sigprint();
...
template <typename eT> inline bool has_nonfinite_triu(const Mat<eT> &A) {
  arma_extra_debug_sigprint();
