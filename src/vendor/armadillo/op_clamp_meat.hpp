...
inline void
op_clamp::apply(Mat<typename T1::elem_type> &out,
  ...
  arma_debug_check((min_val > max_val),
...
inline void op_clamp::apply_direct(Mat<eT> &out, const Mat<eT> &X,
                                   const eT min_val, const eT max_val) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline void
op_clamp::apply_proxy_noalias(Mat<typename T1::elem_type> &out,
                              const Proxy<T1> &P,
...
template <typename T1>
inline void
op_clamp::apply(Cube<typename T1::elem_type> &out,
...
template <typename eT>
inline void op_clamp::apply_direct(Cube<eT> &out, const Cube<eT> &X,
                                   const eT min_val, const eT max_val) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline void
op_clamp::apply_proxy_noalias(Cube<typename T1::elem_type> &out,
...
template <typename T1>
inline void
op_clamp_cx::apply(Mat<typename T1::elem_type> &out,
...
template <typename eT>
inline void op_clamp_cx::apply_direct(Mat<eT> &out, const Mat<eT> &X,
                                      const eT min_val, const eT max_val) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline void
op_clamp_cx::apply_proxy_noalias(Mat<typename T1::elem_type> &out,
                                 const Proxy<T1> &P,
                                 const typename T1::elem_type min_val,
                                 const typename T1::elem_type max_val) {
  arma_extra_debug_sigprint();
...
template <typename eT>
inline void op_clamp_cx::apply_direct(Cube<eT> &out, const Cube<eT> &X,
                                      const eT min_val, const eT max_val) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline void
op_clamp_cx::apply_proxy_noalias(Cube<typename T1::elem_type> &out,
                                 const ProxyCube<T1> &P,
                                 const typename T1::elem_type min_val,
                                 const typename T1::elem_type max_val) {
  arma_extra_debug_sigprint();
    ...
    for (uword s = 0; s < n_slices; ++s)
      for (uword c = 0; c < n_cols; ++c)
        for (uword r = 0; r < n_rows; ++r) {
          ...
          val_real =
              (val_real < min_val_real)
                  ? min_val_real
                  : ((val_real > max_val_real) ? max_val_real : val_real);
          val_imag =
              (val_imag < min_val_imag)
                  ? min_val_imag
                  : ((val_imag > max_val_imag) ? max_val_imag : val_imag);
