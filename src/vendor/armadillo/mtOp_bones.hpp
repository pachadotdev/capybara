...
public:
  ...
  inline mtOp(const T1 &in_m, const uword in_aux_uword_a,
  ...
  inline mtOp(const mtOp_dual_aux_indicator &, const T1 &in_m,
  ...
  arma_aligned out_eT
      aux_out_eT; //!< auxiliary data, using the element type as
