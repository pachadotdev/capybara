...
inline void glue_join_rows::apply_noalias(Mat<typename T1::elem_type> &out,
  ...
  arma_debug_check(
      ((A_n_rows != B_n_rows) && ((A_n_rows > 0) || (A_n_cols > 0)) &&
       ((B_n_rows > 0) || (B_n_cols > 0))),
...
inline void glue_join_rows::apply(Mat<eT> &out, const Base<eT, T1> &A_expr,
  ...
  arma_debug_check(
      ((A.n_rows != out_n_rows) && ((A.n_rows > 0) || (A.n_cols > 0))),
      "join_rows() / join_horiz(): number of rows must be the same");
  arma_debug_check(
      ((B.n_rows != out_n_rows) && ((B.n_rows > 0) || (B.n_cols > 0))),
      "join_rows() / join_horiz(): number of rows must be the same");
  arma_debug_check(
      ((C.n_rows != out_n_rows) && ((C.n_rows > 0) || (C.n_cols > 0))),
      "join_rows() / join_horiz(): number of rows must be the same");
...
inline void glue_join_rows::apply(Mat<eT> &out, const Base<eT, T1> &A_expr,
  ...
  const uword out_n_rows = (std::max)(
      ((std::max)((std::max)(A.n_rows, B.n_rows), C.n_rows)), D.n_rows);
  ...
  arma_debug_check(
      ...
      "join_rows() / join_horiz(): number of rows must be the same");
  arma_debug_check(
      ((D.n_rows != out_n_rows) && ((D.n_rows > 0) || (D.n_cols > 0))),
      "join_rows() / join_horiz(): number of rows must be the same");
...
template <typename T1, typename T2>
inline void
glue_join_slices::apply(Cube<typename T1::elem_type> &out,
