...
#' @title Asymptotic bias correction after fitting binary choice and count
#'  models with a 1,2,3-way error component
#'
...
#'  currently restricted to \code{\link[stats]{binomial}} and
#'  \code{\link[stats]{poisson}} with 1,2,3-way fixed effects.
#'
...
#' 
#' # Same for 'fepoisson()'
#' mod2 <- fepoisson(mpg ~ wt | cyl, mtcars2)
#' mod2_bc <- bias_corr(mod2)
#' summary(mod2_bc)
#' 
#' @export
bias_corr <- function(
